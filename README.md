...
>
> **[Download `firmware-tiny-pdf-reflow-v1.5.0.12.bin`](https://github.com/davemessew/CrossInkPDF/releases/download/pdf-reflow-v1.5.0.12/firmware-tiny-pdf-reflow-v1.5.0.12.bin)**
>
> **Large text — 16, 18, and 20 pt**
>
> **[Download `firmware-xlarge-pdf-reflow-v1.5.0.12.bin`](https://github.com/davemessew/CrossInkPDF/releases/download/pdf-reflow-v1.5.0.12/firmware-xlarge-pdf-reflow-v1.5.0.12.bin)**
>
> [Release page](https://github.com/davemessew/CrossInkPDF/releases/tag/pdf-reflow-v1.5.0.12) · [Installation guide](./docs/installation.md)
>
...
1. Download the [`tiny` firmware](https://github.com/davemessew/CrossInkPDF/releases/download/pdf-reflow-v1.5.0.12/firmware-tiny-pdf-reflow-v1.5.0.12.bin) for standard text or the [`xlarge` firmware](https://github.com/davemessew/CrossInkPDF/releases/download/pdf-reflow-v1.5.0.12/firmware-xlarge-pdf-reflow-v1.5.0.12.bin) for large text.
